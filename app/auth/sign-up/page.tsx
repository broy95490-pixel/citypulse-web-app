      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <h1 className="text-2xl font-bold text-foreground">Join CityPulse</h1>
            <p className="text-sm text-muted-foreground">Create an account to start reporting civic issues</p>
          </div>
